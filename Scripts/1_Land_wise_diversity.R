...
#load data
site_data <- read_excel("~/Desktop/Pratiksha/Data/1_Land_wise_data.xlsx")
...
write.csv(Standardrized_diversity, "~/Desktop/Pratiksha/Standardized_Hill_Diversity_Landuse.csv", row.names = FALSE)
