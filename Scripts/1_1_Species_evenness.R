...
# load data
data <- read_excel("~/Desktop/Pratiksha/Data/1_Land_wise_data.xlsx")
#data <- read_excel("~/Desktop/Pratiksha/Data/6_1_Forest_month_data.xlsx")
...
#data <- read_excel("~/Desktop/Pratiksha/Data/6_Combined_month_data.xlsx")
