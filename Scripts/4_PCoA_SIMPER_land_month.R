...
# Load Data
df <- read_excel("~/Desktop/Pratiksha/Data/3_PCoA_site.xlsx", .name_repair = "unique")
...
# Save Statistics
write.csv(as.data.frame(perm), "~/Desktop/Pratiksha/1_PERMANOVA_Site.csv")
write.csv(pairwise_Site, "~/Desktop/Pratiksha/2_PERMANOVA_Pairwise_Site.csv")
write.csv(as.data.frame(anova(dispersion_test)), "~/Desktop/Pratiksha/3_Dispersion_Check_site.csv")
...
write_csv(final_simper, "~/Desktop/Pratiksha/4_Simper_Site_Top5.csv")


##################
###Months
# Load Data
df <- read_excel("~/Desktop/Pratiksha/Data/4_PCoA_month.xlsx", .name_repair = "unique")
df_dist <- vegdist(df[, -1], method = "bray")
...
# Save Statistics
write.csv(as.data.frame(perm), "~/Desktop/Pratiksha/1_PERMANOVA_Month.csv")
write.csv(pairwise_Month, "~/Desktop/Pratiksha/2_PERMANOVA_Pairwise_month.csv")
write.csv(as.data.frame(anova(dispersion_test)), "~/Desktop/Pratiksha/3_Dispersion_Check_month.csv")
...
final_simper <- bind_rows(lapply(names(simper_summary), extract_top5))
write_csv(final_simper, "~/Desktop/Pratiksha/4_Simper_Month_Top5_month.csv")
