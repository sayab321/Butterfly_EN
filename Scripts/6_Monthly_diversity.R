...
#site wise 
#data <- read_excel("~/Desktop/Pratiksha/Data/6_1_Forest_month_data.xlsx") #forest
#data <- read_excel("~/Desktop/Pratiksha/Data/6_2_Cropland_month_data.xlsx") #cropland
data <- read_excel("~/Desktop/Pratiksha/Data/6_3_Settlement_month_data.xlsx") #settlement
...
#load data
forest <- read_excel("~/Desktop/Pratiksha/Data/6_1_Forest_month_data.xlsx")
cropland <- read_excel("~/Desktop/Pratiksha/Data//6_2_Cropland_month_data.xlsx")
settlement <- read_excel("~/Desktop/Pratiksha/Data/6_3_Settlement_month_data.xlsx")
